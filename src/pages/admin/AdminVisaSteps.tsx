...
export default function AdminVisaSteps() {
  const { steps, updateStep, addStep, deleteStep } = useVisaSteps();
  const [editingStep, setEditingStep] = useState<VisaStep | null>(null);
  const [isCreating, setIsCreating] = useState(false);

  const [newStep, setNewStep] = useState<Partial<VisaStep>>({
    title: "",
    type: "information",
    status: "pending",
    instructions: {

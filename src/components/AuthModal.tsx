          ...
          <div className="p-8">
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-white border-2 border-gray-200 text-gray-700 py-3 px-6 rounded-xl font-semibold text-lg shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 hover:border-red-300 flex items-center justify-center gap-3 group"
              >
